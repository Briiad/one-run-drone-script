...
while True:
    ...
    for detection in detections:
        ...
        # distance between centroid and middle of the resized
        distance = math.sqrt((detection.Center[0] - int(resized.shape[1] / 2))**2 + (detection.Center[1] - int(resized.shape[0] / 2))**2)
        # draw distance
